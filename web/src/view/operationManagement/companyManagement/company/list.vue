  ...
  <div>
    <div class="gva-search-box">
      <el-form ref="searchForm" :inline="true" :model="searchInfo">
        <el-form-item label="主体ID/主体名称">
          <el-input v-model="searchInfo.company_name" placeholder="主体ID/主体名称" />
        </el-form-item>
        <el-form-item>
    ...
    <div class="gva-table-box">
      <div class="gva-btn-list">
        <el-button type="primary" icon="plus" @click="openAddConfigDialog">新增主体</el-button>
      </div>
    ...
    >
      <el-form ref="configForm" :model="configInfo" :rules="rules" label-width="80px">
        ...
        <el-form-item label="主体名称" prop="company_name">
          <el-input v-model="configInfo.company_name" placeholder="请输入主体名称"/>
        </el-form-item>
        <el-form-item label="用户协议">
          <el-input v-model="configInfo.user_agreement_url" placeholder="请输入用户协议"/>
        </el-form-item>
        <el-form-item label="隐私协议">
          <el-input v-model="configInfo.privacy_policy_url" placeholder="请输入隐私协议"/>
        </el-form-item>
      </el-form>
      <template #footer>
...
import { companyList, companyAdd, companyModify } from '@/api/operationManagement'
  ...
  configForm.value.validate(async (valid) => {
    if (valid) {
      if (configDialog.value.add) {
        const res = await companyAdd(configInfo.value)
        if (res.code === 0) {
        ...
        const res = await companyModify(configInfo.value)
        if (res.code === 0) {
