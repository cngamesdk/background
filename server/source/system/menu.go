...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	childMenus := []SysBaseMenu{
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["operationManagement"], Path: "payChannelSwitchList", Name: "payChannelSwitchList", Component: "view/operationManagement/payChannelManagement/switch/list.vue", Sort: 8, Meta: Meta{Title: "支付切换"}},
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["operationManagement"], Path: "globalCommonConfigList", Name: "globalCommonConfigList", Component: "view/operationManagement/globalCommonConfig/list/list.vue", Sort: 11, Meta: Meta{Title: "全局通用配置"}},
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["operationManagement"], Path: "gamePackagingConfigList", Name: "gamePackagingConfigList", Component: "view/operationManagement/gamePackaging/config/list.vue", Sort: 12, Meta: Meta{Title: "游戏打包配置"}},
		...
		{MenuLevel: 1, Hidden: false, ParentId: menuNameMap["advertising"], Path: "advertisingMixList", Name: "advertisingMixList", Component: "view/advertising/mix/list.vue", Sort: 70, Meta: Meta{Title: "广告组合"}},
		{MenuLevel: 1, Hidden: true, ParentId: menuNameMap["advertising"], Path: "advertisingMixConfig", Name: "advertisingMixConfig", Component: "view/advertising/mix/mix.vue", Sort: 80, Meta: Meta{Title: "组合配置"}},
