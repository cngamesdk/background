...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "主体管理", Method: "POST", Path: "/operation_management/company/list", Description: "列表"},
		{ApiGroup: "主体管理", Method: "POST", Path: "/operation_management/company/add", Description: "创建"},
		{ApiGroup: "主体管理", Method: "POST", Path: "/operation_management/company/modify", Description: "修改"},
		{ApiGroup: "产品配置管理", Method: "POST", Path: "/operation_management/product_common_configuration/list", Description: "产品通用配置列表"},
		{ApiGroup: "产品配置管理", Method: "POST", Path: "/operation_management/product_common_configuration/add", Description: "产品通用配置添加"},
		{ApiGroup: "产品配置管理", Method: "POST", Path: "/operation_management/product_common_configuration/modify", Description: "产品通用配置修改"},
		{ApiGroup: "产品配置管理", Method: "POST", Path: "/operation_management/game_app_version_configuration/list", Description: "游戏版本配置列表"},
		{ApiGroup: "产品配置管理", Method: "POST", Path: "/operation_management/game_app_version_configuration/add", Description: "游戏版本配置添加"},
		{ApiGroup: "产品配置管理", Method: "POST", Path: "/operation_management/game_app_version_configuration/modify", Description: "游戏版本配置修改"},
		{ApiGroup: "联运管理", Method: "POST", Path: "/operation_management/publishing/channel/list", Description: "联运渠道列表"},
		{ApiGroup: "联运管理", Method: "POST", Path: "/operation_management/publishing/channel/add", Description: "联运渠道新增"},
		{ApiGroup: "联运管理", Method: "POST", Path: "/operation_management/publishing/channel/modify", Description: "联运渠道修改"},
		{ApiGroup: "联运管理", Method: "POST", Path: "/operation_management/publishing/channel-game/list", Description: "联运渠道游戏列表"},
		{ApiGroup: "联运管理", Method: "POST", Path: "/operation_management/publishing/channel-game/add", Description: "联运渠道游戏新增"},
		{ApiGroup: "联运管理", Method: "POST", Path: "/operation_management/publishing/channel-game/modify", Description: "联运渠道游戏修改"},
		{ApiGroup: "定时任务", Method: "POST", Path: "/cron-task/config/list", Description: "任务列表"},
		{ApiGroup: "定时任务", Method: "POST", Path: "/cron-task/config/add", Description: "任务添加"},
		{ApiGroup: "定时任务", Method: "POST", Path: "/cron-task/config/modify", Description: "任务修改"},
		{ApiGroup: "定时任务", Method: "POST", Path: "/cron-task/log/list", Description: "任务日志列表"},
		...
		{ApiGroup: "广告管理", Method: "POST", Path: "/advertising/agent/list", Description: "渠道列表"},
		{ApiGroup: "广告管理", Method: "POST", Path: "/advertising/agent/add", Description: "渠道新增"},
		{ApiGroup: "广告管理", Method: "POST", Path: "/advertising/agent/modify", Description: "渠道修改"},
		{ApiGroup: "广告管理", Method: "POST", Path: "/advertising/site/list", Description: "广告位列表"},
		...
		{ApiGroup: "支付渠道管理", Method: "POST", Path: "/operation_management/pay_channel/modify", Description: "修改"},
		{ApiGroup: "支付渠道切换", Method: "POST", Path: "/operation_management/pay_channel_switch/list", Description: "列表"},
		{ApiGroup: "支付渠道切换", Method: "POST", Path: "/operation_management/pay_channel_switch/add", Description: "新增"},
		{ApiGroup: "支付渠道切换", Method: "POST", Path: "/operation_management/pay_channel_switch/modify", Description: "修改"},
		{ApiGroup: "数据报表", Method: "POST", Path: "/data-report/day-overview/list", Description: "每日总览"},
		{ApiGroup: "数据报表", Method: "POST", Path: "/data-report/retention-status/list", Description: "留存情况"},
		{ApiGroup: "数据报表", Method: "POST", Path: "/data-report/payment-status/list", Description: "付费情况"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/sub_game/list", Description: "子游戏列表"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/sub_game/config", Description: "子游戏配置"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/sub_game/add", Description: "子游戏新增"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/sub_game/modify", Description: "子游戏修改"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/root_game/list", Description: "根游戏列表"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/root_game/add", Description: "根游戏新增"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/root_game/modify", Description: "根游戏修改"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/main_game/list", Description: "主游戏列表"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/main_game/add", Description: "主游戏新增"},
		{ApiGroup: "游戏管理", Method: "POST", Path: "/operation_management/game_manage/main_game/modify", Description: "主游戏修改"},
		{ApiGroup: "全局通用配置", Method: "POST", Path: "/operation_management/global-common-config/list", Description: "列表"},
