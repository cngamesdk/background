...
func (i *initApi) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []sysModel.SysApi{
		...
		{ApiGroup: "发行管理", Method: "POST", Path: "/operation_management/publishing/channel/list", Description: "发行渠道列表"},
		{ApiGroup: "发行管理", Method: "POST", Path: "/operation_management/publishing/channel/add", Description: "发行渠道新增"},
		{ApiGroup: "发行管理", Method: "POST", Path: "/operation_management/publishing/channel/modify", Description: "发行渠道修改"},
		{ApiGroup: "发行管理", Method: "POST", Path: "/operation_management/publishing/channel-game/list", Description: "发行渠道游戏列表"},
		{ApiGroup: "发行管理", Method: "POST", Path: "/operation_management/publishing/channel-game/add", Description: "发行渠道游戏新增"},
		{ApiGroup: "发行管理", Method: "POST", Path: "/operation_management/publishing/channel-game/modify", Description: "发行渠道游戏修改"},
